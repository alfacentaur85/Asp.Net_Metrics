...
<<<<<<< HEAD
            ...
            cmd.CommandText = string.Concat("INSERT INTO ", MetricsType.metricsList[(int)MetricsTypeEnum.CPU_METRICS] , "(value, time) VALUES(@value, @time)");
...
<<<<<<< HEAD
            ...
            cmd.CommandText = string.Concat("DELETE FROM ", MetricsType.metricsList[(int)MetricsTypeEnum.CPU_METRICS], " WHERE id=@id");
...
<<<<<<< HEAD
            ...
            cmd.CommandText = string.Concat("SELECT * FROM ", MetricsType.metricsList[(int)MetricsTypeEnum.CPU_METRICS]);
